...
def make_args(input = None):
    ...
    parser.add_argument('--ner_law', dest='ner_law', default=False, type=str2bool)
    parser.add_argument('--law', dest='law', default=False, type=str2bool)
    parser.add_argument('--domain', dest='domain', default=True, type=str2bool)
    parser.add_argument('--bert', dest='bert', default=False, type=str2bool)
    ...
    parser.add_argument('--epoch_num', dest='epoch_num', default=500, type=int)
