...
def load_datafile(args):
    ...
    if os.path.exists(folder+'A_sp.npz'):
        A = sp.load_npz(folder + 'A_sp.npz')
        X = sp.load_npz(folder + 'X_DOMAIN.npz')
        if args.ner_law:
            X = sp.load_npz(folder + 'X_NER_LAW.npz')
        elif args.law:
            X = sp.load_npz(folder + 'X_LAW.npz')
        elif args.bert:
            X = sp.load_npz(folder + 'X_BERT.npz')
...
def create_input_data(args):
    ...
    X = sp.load_npz(str(path) + "X_DOMAIN.npz")
    if args.ner_law:
        print("NER LAW")
        X = sp.load_npz(str(path) + "X_NER_LAW.npz")
    elif args.law:
        print("LAW")
        X = sp.load_npz(str(path) + "X_LAW.npz")
    elif args.bert:
        print("BERT")
        X = sp.load_npz(str(path) + "X_BERT.npz")
